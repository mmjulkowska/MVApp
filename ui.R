    ...
    tabPanel("Data exploration", icon=icon("binoculars"),
             navbarPage("",
                        ...
                        tabPanel("Categorical data analysis",
                                 ...
                                 mainPanel(
                                   navbarPage("",
                                              tabPanel("Mosaic plots", icon=icon("area-chart"),
                                                       "***Comments on independence test results, p-values, etc.***",
                                                       # uiOutput("MosaicType"), # option to select different plot type
                                                       #verbatimTextOutput("CatChi"),
                                                       #dataTableOutput("Cat_tab"),
                                                       #tableOutput("Cat_tab"),
                                                       verbatimTextOutput("Chitest"),
                                                       verbatimTextOutput("Model"),
                                                       downloadButton("download_MosaicPlot", "Download plot"),
                                                       plotlyOutput("CatPlot", width = 1000)
                                                       ),
                                              
                                              
                                              tabPanel("Mosaic plots - notes",
