         ...
         mainPanel(
           navbarPage("",
                      ...
                      tabPanel("One / two sample tests", icon = icon("hand-peace-o"),
                               ...
                               column(12,downloadButton("OT_graph_download", "Download plot")),
                      ...
                      tabPanel("Testing significant differences", icon=icon("sun-o"),
                               ...
                               downloadButton("ANOVA_graph_download", "Download plot"),
                               plotlyOutput("Boxes"),
               ...
               mainPanel(
                 navbarPage("",
                   tabPanel("Mosaic plots",
                            ...
                            "This tab is currently under construction - main contributors Stephanie Saade & Mitchell Morton with sateline help from Magdalena Julkowska", br(),
  ...
  navbarPage("",
    tabPanel(
      ...
      sidebarPanel(
        ...
        numericInput("Cor_Big_steps", "Number of levels:", value = 100),
...
navbarPage("",
  ...
  mainPanel(
    navbarPage("PCA the crazy",
               ...
               tabPanel("Contribution of variables",
                        ...
                        column(12,downloadButton("downl_PCA_scatterplot", "Download plot"), 
  ...
  tabPanel("Multidimensional Scaling",
           ...
           mainPanel("some graphs",br(),
                     "This tab is currently under construction - main contributors Mariam Awlia & Magdalena Julkowska", br(),
                     "Please be patient and send us an e mail in case you have some analysis you would like to include in the App", br(), br(),
                     "Chers & glittes data-analyst!"
                     )
           ))
         ...
         mainPanel(
           navbarPage("Happy clustering",
                      tabPanel("Clustering your HOT HOT Data",
                               ...
                               downloadButton("downl_HHeatMap", "Download plot"),
                               plotOutput("HotHeatMap"),
                               br(),
                               hr(),
                               verbatimTextOutput("Dendro_sentence"),
                               downloadButton("downl_ClusterTree", "Download plot"),
                      ...
                      tabPanel("Cluster validation",
                               ...
                               downloadButton("downl_HotANOVA", "Download plot"),
                               plotOutput("HotANOVA"),
                               hr(),
