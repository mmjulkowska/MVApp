               ...
               navbarPage("",
                          ...
                          tabPanel("Examine differences",
                                   ...
                                   column(4, uiOutput("Select_model_color_to_plot"),
                                          ...
                                          selectInput("model_color_palette", "Choose color palette", choices = c("default", "Accent", "Blues", "Dark2", "Pastel1", "Pastel2", "Pastel3", "Paired", "Set1", "Set2", "Set3",  "Spectral", "BrBG", "PiYG", "PRGn", "PuOr", "RdBu", "RdGy", "RdYlBu", "RdYlGn")),
                                          checkboxInput("model_legend", "Remove legend"),
                                          checkboxInput("model_tit_q", "Add graph title"),
                                          uiOutput("model_tit_ui"),
                                          checkboxInput("model_y_lim_q", "Determine the y-axis range"),
                                          uiOutput("model_y_lim_min"),
                                          uiOutput("model_y_lim_max")),
                                   column(4, numericInput(
                                     ...
                                     checkboxInput("model_x_q","Write your own x-axis"),
                                     uiOutput("model_alt_x"),
                                     checkboxInput("model_y_q","Write your own y-axis"),
                                     uiOutput("model_alt_y")),
                                   hr(),
               ...
               fluidRow(
                 navbarPage("",
                            ...
                            tabPanel("Tweak the graphs",
                                     ...
                                     br(),
                                      selectInput("OUT_color_palette", "Choose color palette", choices = c("default", "Accent", 
                                                                                                           "Blues", "Dark2", "Pastel1", "Pastel2", "Pastel3", "Paired", "Set1", "Set2", "Set3",  "Spectral", "BrBG", "PiYG", "PRGn", "PuOr", "RdBu", "RdGy", "RdYlBu", 
                                                                                                           "RdYlGn")),
                                      checkboxInput("OUT_legend", "Remove legend"),
                                      checkboxInput("OUT_tit_q", "Add graph title"),
                                      uiOutput("OUT_tit_ui"),
                                      checkboxInput("OUT_y_lim_q", "Determine the y-axis range"),
                                      uiOutput("OUT_y_lim_min"),
                                      uiOutput("OUT_y_lim_max"),
                                      checkboxInput("OUT_x_q","Write your own x-axis"),
                                      uiOutput("OUT_alt_x"),
                                      checkboxInput("OUT_y_q","Write your own y-axis"),
                                      uiOutput("OUT_alt_y")
                 )
                 ))),
             mainPanel(
                                 ...
                                 mainPanel(
                                   navbarPage("",
                                              ...
                                              tabPanel("One / two sample tests", icon = icon("hand-peace-o"),
                                                       ...
                                                       column(4, selectInput("ttest_graph_type", "Choose the graph type", choices = c("box plot", "box plot + jitter", "scatter plot", "violin plot", "violin plot + jitter")),
                                                                  selectInput("ttest_color_palette", "Choose color palette", choices = c("default", "Accent", "Blues", "Dark2", "Pastel1", "Pastel2", "Pastel3", "Paired", "Set1", "Set2", "Set3",  "Spectral", "BrBG", "PiYG", "PRGn", "PuOr", "RdBu", "RdGy", "RdYlBu", "RdYlGn")),
                                                                  checkboxInput("ttest_legend", "Remove legend")),
                                                       column(4, checkboxInput("ttest_tit_q", "Add graph title"),
                                                                  uiOutput("ttest_tit_ui"),
                                                                  checkboxInput("ttest_y_lim_q", "Determine the y-axis range"),
                                                                  uiOutput("ttest_y_lim_min"),
                                                                  uiOutput("ttest_y_lim_max")),
                                                       column(4, checkboxInput("ttest_x_q","Write your own x-axis"),
                                                              uiOutput("ttest_alt_x"),
                                                              checkboxInput("ttest_y_q","Write your own y-axis"),
                                                              uiOutput("ttest_alt_y"))
                                              ),
                                              tabPanel("Testing significant differences", icon=icon("sun-o"),
                                                       ...
                                                       column(4, selectInput("ANOVA_color", "Choose color palette", choices = c("default", "Accent", "Blues", "Dark2", "Pastel1", "Pastel2", "Pastel3", "Paired", "Set1", "Set2", "Set3",  "Spectral", "BrBG", "PiYG", "PRGn", "PuOr", "RdBu", "RdGy", "RdYlBu", "RdYlGn")),
                                                                  checkboxInput("ANOVA_legend", "Remove legend"),
                                                                  checkboxInput("ANOVA_tit_q", "Add graph title"),
                                                                  uiOutput("ANOVA_tit")),
                                                       column(4,checkboxInput("ANOVA_y_lim_q", "Determine the y-axis range"),
                                                                  uiOutput("ANOVA_y_lim_min"),  
                                                                  uiOutput("ANOVA_y_lim_max"),  
                                                                  checkboxInput("ANOVA_x_q","Write your own x-axis"),
