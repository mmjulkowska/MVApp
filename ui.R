         ...
         mainPanel(
           navbarPage("",
                      tabPanel("Testing normal distribution", icon=icon("area-chart"),
                               ...
                               checkboxInput("R_hist_chk", "Show me the code"),
                               uiOutput("R_histo_ui"),
                      ...
                      tabPanel("Testing equal variance", icon=icon("area-chart"),
                               ...
                               column(12,
                                      checkboxInput("R_var_chk", "Show me the code"),
                                      uiOutput("R_var_ui"),
                      ...
                      tabPanel("Testing significant differences", icon=icon("sun-o"),
                               ...
                               selectInput("ANOVA_graph_type", "Type of graph", choices = c("box plot","box plot + jitter", "scatter plot", "violin plot", "violin plot + jitter")),
